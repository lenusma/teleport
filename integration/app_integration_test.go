...
type appTestOptions struct {
	...
	rootClusterListeners *helpers.InstanceListeners
	leafClusterListeners *helpers.InstanceListeners
...
func setupWithOptions(t *testing.T, opts appTestOptions) *pack {
	...
	p.rootCluster = helpers.NewInstance(t, helpers.InstanceConfig{
		...
		Pub:         publicKey,
		Log:         log,
		Listeners:   opts.rootClusterListeners,
	})

	// Create a new Teleport instance with passed in configuration.
	p.leafCluster = helpers.NewInstance(t, helpers.InstanceConfig{
		...
		Pub:         publicKey,
		Log:         log,
		Listeners:   opts.leafClusterListeners,
	})
